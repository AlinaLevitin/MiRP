...
class SegmentAverageGenerator(MethodBase):
    ...
    def __init__(self, input_directory, output_directory, particles_star_file):
        """
        ...
        """
        self.input_directory = input_directory.get()
        self.output_directory = output_directory.get()
        self.particles_star_file = particles_star_file.get()

    @print_done_decorator
    def generate_segment_averages(self):
        ...
        output_path = os.path.join(self.output_directory, "segment_averages")
        ...
        if "segment_averages" not in os.listdir(self.output_directory):
        ...
        for dir_path, _, filenames in os.walk(self.input_directory):
